...
public class BarChartViewController extends ChartViewController {
  ...
  public void actionPerformed(ActionEvent e) {
    if (e.getActionCommand().equals("printChart")) {
      ...
      chart.getCategoryPlot().getDomainAxis().setLabel(xAxisLabelField.getText());
    } else if (e.getActionCommand().equals("changeYAxisLabel")) {
      chart.getCategoryPlot().getRangeAxis().setLabel(yAxisLabelField.getText());
    }
  }
}
